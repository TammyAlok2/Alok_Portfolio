...
const projects = [
    {
        ...
        description: "An eco-friendly online marketplace specializing in bamboo products.",
        image: "/projects/bomboo_world.png",
        category: "Web Development",
        tech: ["Next JS", "Tailwind CSS", "CSS", "Zustand", "Node JS", "Express JS", "Mongo DB"],
    ...
    },
    {
        ...
        description: "A digital healthcare platform connecting patients with medical professionals.",
        image: "/projects/yourlab.png",
        category: "Healthcare",
        tech: ["Next JS", "Tailwind CSS", "CSS", "Redux JS", "On-page SEO", "Node JS", "Express JS", "Mongo DB"],
    ...
    },
    {
        ...
        description: "An online store specializing in premium interior design products.",
        image: "/projects/creative_interior.png",
        category: "E-Commerce",
        tech: ["Next JS", "Tailwind CSS", "CSS", "Redux JS", "Node JS", "Express JS", "Mongo DB"],
                    ...
                    {selectedProject && (
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="p-8">
                                    <span className="text-sm text-emerald-600 font-medium">{selectedProject.category}</span>
